# Generated by Django 2.2.16 on 2022-03-08 11:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[django.core.validators.MinValueValidator(1902), django.core.validators.MaxValueValidator(2022)])),
                ...
                ('genre', models.ManyToManyField(blank=True, to='reviews.Genres')),
            ],
        ),
        migrations.CreateModel(
            name='Reviews',
        ...
        migrations.AddConstraint(
            model_name='genres',
            constraint=models.UniqueConstraint(fields=('name', 'slug'), name='unique_name_slug_genres'),
        ),
        migrations.AddField(
            model_name='comments',
            name='author',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('name', 'slug'), name='unique_name_slug_categories'),
        ),
        migrations.AddField(
